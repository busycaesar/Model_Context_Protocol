...
![Image Alt](https://skillicons.dev/icons?i=py,ts,js)
...
- [Topic: GitHub MCP Server with VS Code copilot](./github)
- After Event Photos
  - [LinkedIn](https://www.linkedin.com/feed/update/urn:li:activity:7327159234872184832)
...
- [Topic: Firebase MCP Server using JS](./firebase-node)
